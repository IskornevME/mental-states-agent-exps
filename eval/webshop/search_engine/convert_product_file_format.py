"""From https://github.com/princeton-nlp/WebShop."""
...
# Add repository root to Python path so imports work regardless of
# the directory from which this script is executed.
REPO_ROOT = Path(__file__).resolve().parents[3]
sys.path.insert(0, str(REPO_ROOT))

from eval.webshop.web_agent_site.utils import DEFAULT_FILE_PATH
from eval.webshop.web_agent_site.engine.engine import load_products
